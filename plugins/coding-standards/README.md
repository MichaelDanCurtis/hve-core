...
Experimental: Coding instructions and pre-PR code review agents for bash, Bicep, C#, PowerShell, Python, Rust, Terraform. AS-IS. Feedback: github.com/microsoft/hve-core/issues
