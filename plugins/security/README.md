...
| **security/sssc-planner**                | SSSC Planner identity, orchestration, and per-phase protocols: six-phase workflow, state.json schema, session recovery, question cadence, and the Phase 2-6 assessment, standards mapping, gap analysis, backlog, and handoff protocols                                      |
