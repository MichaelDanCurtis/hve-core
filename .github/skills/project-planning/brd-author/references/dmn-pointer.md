...
* As the notation family selected by the [`process-modeling`](process-modeling.md#notation-selection) decision when a requirement is decision- or rule-oriented.
