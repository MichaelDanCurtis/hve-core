...
The BRD Builder applies RICE under the following operating rules, which are original Microsoft synthesis informed by the scheme selector in [prioritization-schemes.md](prioritization-schemes.md):
