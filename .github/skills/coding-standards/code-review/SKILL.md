...
9. [Cross-Skill Forks](references/cross-skill-forks.md) — collection-aware fork catalog for specialist follow-up.
...
* `references/` — durable review knowledge documents.
  ...
  * `cross-skill-forks.md` — specialist fork catalog and gating rules.
